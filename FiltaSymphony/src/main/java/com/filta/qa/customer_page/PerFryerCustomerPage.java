...
public class PerFryerCustomerPage
{
	...
	public String goToCustomer()
	{
		...
		sa.assertEquals(customerURL, perFryerData.getCellData(1, 0));
		selectAll.click();
		...
		{
			if (Array[i].equals(prop.getProperty("Customer2")))
			{
	...
	public void basicInfo()
	{
		...
		siteStreet.sendKeys(perFryerData.getCellData(1, 9));
		siteCity.sendKeys(perFryerData.getCellData(1, 10));
		siteState.sendKeys(perFryerData.getCellData(1, 11));
		sitePostalCode.sendKeys((int) perFryerData.getCellDataInt(1, 12) + "");
		siteCountry.sendKeys(perFryerData.getCellData(1, 13));
...
//		Mobile.sendKeys((int) PerFryerData.getCellDataInt(1, 18) + "");
		ncaSupplier.sendKeys((int) perFryerData.getCellDataInt(1, 19) + "");
		...
		globalObj.select(serviceFrequency).selectByVisibleText(perFryerData.getCellData(1, 25));
	}
	...
	public void pricing()
	{
		...
		if (filtaFry.isSelected() == false)
		{
			filtaFry.click();
			lodar();
			globalObj.select(pricingModel).selectByVisibleText("Per Fryer");
			actualPerFryerInformativeMessage = globalObj.alert("accept", driver);
			lodar();
